...
export default function InputComponent(props) {
    ...
    return (
        <div className={props.className}>
            ...
            <input onChange={props.onChange} disabled={props.disabled ? props.disabled : false} type={props.type ? props.type : "text"} value={props.value} id={props.name} className={!props.errors[props.name] ? "form-control-plaintext" : "form-control-plaintext is-invalid"} placeholder={props.placeholder}
