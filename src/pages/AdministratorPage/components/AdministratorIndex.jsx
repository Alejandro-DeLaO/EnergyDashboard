    ...
    return (
        <section className="pt-4 pb-5 row container-xxl m-auto text-center mb-5">
            ...
            <div className="row d-flex justify-content-center section-container gap-3 m-auto my-5">
                <SectionComponent to='/administrador/subirDatos' img='/assets/uploadData.png' text='Subir archivos' elevation="-25%" marginL="50px" />
                <SectionComponent to='/administrador/manipularDatos' img='/assets/editData.png' text='Manipular información' elevation="-30%" marginL="20px" />
            </div>
        </section>
    );
}